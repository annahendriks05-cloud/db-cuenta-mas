        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-16 h-16 bg-[#0018A8] flex items-center justify-center p-2">
                <svg viewBox="0 0 100 100" className="w-full h-full" fill="none">
                  <rect x="10" y="10" width="80" height="80" fill="none" stroke="white" strokeWidth="8"/>
                  <path d="M20 80 L80 20" stroke="white" strokeWidth="8"/>
                </svg>
              </div>
              <div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-white/90"><strong className="text-white">Kostenlose EURC/EURUA IBAN:</strong> Ihr persönliches sicheres Konto</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          >
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-xs text-gray-700 space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold">✓</span>
                  <span><strong>Kostenlose digitale EURC/EURUA IBAN:</strong> Ihr persönliches sicheres Konto</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 font-bold">✓</span>
